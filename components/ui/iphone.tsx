...
export function Iphone({
  ...
  return (
    <div
      ...
      {...props}
    >
      {/* Solid black base layer so background never leaks through */}
      <div
        className="pointer-events-none absolute inset-[1.5%] bg-black rounded-[52px] z-0"
      />

      {hasVideo && (
        <div
          className="pointer-events-none absolute z-[1] overflow-hidden bg-black"
          style={{
            left: `${LEFT_PCT}%`,
            top: `${TOP_PCT}%`,
            width: `${WIDTH_PCT}%`,
